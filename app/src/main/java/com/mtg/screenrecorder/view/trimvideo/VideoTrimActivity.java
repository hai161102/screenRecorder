package com.mtg.screenrecorder.view.trimvideo;
...
import com.mtg.screenrecorder.view.trimvideo.trimlib.BackgroundTask;
import com.mtg.screenrecorder.view.trimvideo.trimlib.OnVideoTrimListener;
import com.mtg.screenrecorder.view.trimvideo.trimlib.TrimVideoUtils;
import com.mtg.screenrecorder.widget.LoadingDialog;
...
//        });
    ...
    private void playVideo(String path) {
        ...
        if (player == null) return;
        ProgressiveMediaSource source = new ProgressiveMediaSource.Factory(dataSourceFactory).createMediaSource(MediaItem.fromUri(Uri.parse(path)));
