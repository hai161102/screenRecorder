...
public final class LayoutNotificationRecordingRtlBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutNotificationRecordingRtlBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static LayoutNotificationRecordingRtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutNotificationRecordingRtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_notification_recording_rtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutNotificationRecordingRtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutNotificationRecordingRtlBinding((FrameLayout) rootView, imvRecord, layout,
