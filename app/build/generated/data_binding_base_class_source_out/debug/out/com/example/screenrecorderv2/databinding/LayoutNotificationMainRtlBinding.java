...
public final class LayoutNotificationMainRtlBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutNotificationMainRtlBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static LayoutNotificationMainRtlBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutNotificationMainRtlBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_notification_main_rtl, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutNotificationMainRtlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutNotificationMainRtlBinding((FrameLayout) rootView, imvCapture, imvCc,
          imvHome, imvRecord, layout, notiExit, notiHome, notiRecord, notiScreenShot, notiTools,
          tvClose, tvHome, tvRecord, tvScreenshot, tvTools);
    }
