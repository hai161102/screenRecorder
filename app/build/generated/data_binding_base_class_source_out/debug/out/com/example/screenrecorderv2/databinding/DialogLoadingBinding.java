...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar pbLoading) {
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLoadingBinding((ConstraintLayout) rootView, pbLoading);
    }
